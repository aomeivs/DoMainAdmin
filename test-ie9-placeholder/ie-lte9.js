//修复IE8问题
//1. array.indexof is underfind
//2. console.X is underfind
...
~function() {
    $.fn.placeholder = function(option, callback) {
        ...
        function bootstrap($that) {
            ...
            // redner
            var $placeholder = $('<span class='+settings.className+'>')
            $placeholder.css({
                position: 'absolute',
                zIndex: '20',
                top: top,
     ...
     *
     */
    $.placeholderInit = function (options) {
        var defaults = {
            replaceAll:true
        }
        var opts = $.extend({},defaults,options);
        if(!placeholderSupport()&&opts.replaceAll){
        ...
        return opts.replaceAll||placeholderSupport();
    }
